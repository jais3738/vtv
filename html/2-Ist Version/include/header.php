            ...
            <div class="col-12">
              <div class="d-block d-md-flex align-items-center text-center">
                <div class="me-4 d-inline-block py-1">
                  <a href="#"><i class="far fa-envelope me-2 fa-flip-horizontal text-primary"></i>virtualtechvibes@gmail.com</a>
                </div>

                <div class="me-auto d-inline-block py-1">
                  <!-- <a href="tel:1-800-555-1234"><i class="fas fa-map-marker-alt text-primary me-2"></i>Ghaziabad, UP, 201001</a>-->
                </div>
      ...
      <nav class="navbar bg-white navbar-static-top navbar-expand-lg">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="index.php">
            <img class="img-fluid" src="img/logo_virtual_tech_vibes.png" alt="logo">
          </a>
