        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title is-sticky" style="top: 80px;">
              ...
              <a href="https://themes.potenzaglobalsolutions.com/html/hi-soft/#" class="btn btn-primary-round btn-round">See All Services<i class="fas fa-arrow-right ps-3"></i></a>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              <div class="col-sm-6">
                <div class="feature-info feature-info-style-01">
                  ...
                  <div class="feature-info-content">
                    ...
                    <a href="https://themes.potenzaglobalsolutions.com/html/hi-soft/service-detail.html" class="icon-btn"><i class="fas fa-long-arrow-alt-right"></i></a>
                  </div>
                </div>
